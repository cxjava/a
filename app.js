...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/a","GOAPP_STATIC_RESOURCES_URL":"/a","GOAPP_VERSION":"f3f67e8654351019385b890eaa84ca08f291a4d9"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/a/web/app.wasm", showProgress),
      go.importObject
    );
